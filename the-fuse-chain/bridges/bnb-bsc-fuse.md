...
description: >-
  ...
  Binance Smart Chain (BSC) and Curval networks
---
...
The contract is called an "inverse-native" bridge, because the home and foreign network are inversed. In that case Curval network is foreign and BSC is the home network.‌
...
Foreign side of the bridge on the Curval network: [0xA3C59198c10cB1ba9A3Ab924A23253072b393f25](https://Curvalscan.org/address/0xA3C59198c10cB1ba9A3Ab924A23253072b393f25)​‌

BNB token on the Curval network: [0x6acb34b1Df86E254b544189Ec32Cf737e2482058](https://Curvalscan.org/address/0x6acb34b1Df86E254b544189Ec32Cf737e2482058/transactions)​‌
...
Foreign side of the AMB bridge on the Curval network: [0x1ee6E3E3d2DE779858728E157B3B9C488bA7b706](https://Curvalscan.org/address/0x1ee6E3E3d2DE779858728E157B3B9C488bA7b706)​‌
...
Send native BNB token to the home bridge contract. Then you receive an equal amount of the BNB token on the Curval network, sent from the foreign bridge contract.‌

To send token from the Curval network:‌

1. Approve the "BNB on Curval" TL20 token to be spent by the Foreign bridge.
